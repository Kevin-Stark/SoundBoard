package com.kevin.soundboard.ui;
/*Date: 04/03/2012
...
import com.kevin.soundboard.EditActivity;
import com.kevin.soundboard.PlayActivity;
import com.kevin.soundboard.R;
import com.kevin.soundboard.Recorder;
import com.kevin.soundboard.SnipperActivity;
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            if (v.getId() == R.id.About) {
                view.setImageResource(R.mipmap.about1);
            } else if (v.getId() == R.id.Start) {
                view.setImageResource(R.mipmap.start1);
            } else if (v.getId() == R.id.Edit) {
                view.setImageResource(R.mipmap.edit1);
            } else if (v.getId() == R.id.Snipper) {
                view.setImageResource(R.mipmap.snip1);
            } else if (v.getId() == R.id.recorder) {
                view.setImageResource(R.mipmap.recorder1);
            }

        } else if (event.getAction() == MotionEvent.ACTION_UP) {
            if (v.getId() == R.id.About) {
                view.setImageResource(R.mipmap.about0);
                about(v);
            } else if (v.getId() == R.id.Start) {
                view.setImageResource(R.mipmap.start0);
                start(v);
            } else if (v.getId() == R.id.Edit) {
                view.setImageResource(R.mipmap.edit0);
                edit_Mode(v);
            } else if (v.getId() == R.id.Snipper) {
                view.setImageResource(R.mipmap.snip0);
                snip_it(v);
            } else if (v.getId() == R.id.recorder) {
                view.setImageResource(R.mipmap.recorder0);
                record(v);
            }
        }
