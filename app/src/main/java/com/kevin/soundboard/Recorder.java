...
public class Recorder implements Runnable, OnCompletionListener, OnTouchListener {
    ...
    public void record(View v) { //Record the users voice
        ...
        if (recording == 0) {
            ...
            recording = 1;
            start.start();
            view.setImageResource(R.mipmap.record3);
        } else {
            RAR.stop();
            RAR.reset();
            RAR.release();
            ...
            recording = 0;
            start.stop();
            view.setImageResource(R.mipmap.record2);
    ...
    public void replay(View v) { //Allows the user to replay the recording with the name requested
        ...
        if (mp.isPlaying()) {
            mp.stop();
            mp.reset();
            v.setBackgroundResource(R.mipmap.pause1);
        } else {
            try {
                ...
                v.setBackgroundResource(R.mipmap.play1);
    ...
    public void onCompletion(MediaPlayer arg0) {
        ...
        view.setBackgroundResource(R.mipmap.pause1);
    }
